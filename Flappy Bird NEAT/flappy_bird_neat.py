...
bg_img = pygame.transform.scale(pygame.image.load(os.path.join("imgs","bg.png")).convert_alpha(), (288, 512))
...
class Bird:
    ...
    def move(self):
        ...
        if displacement < 0:
            displacement -= 2
        """
        if self.vel < self.MAX_VEL_Y and not self.jumped:  # not on jump frame   
            self.vel += self.ACC_Y
...
class Pipe():
    ...
    def set_height(self):
        ...
        :return: None
        """
        self.height = random.randrange(70, 200)
